...
import appPreviesImg from '../assets/app-nlw-copa-preview.png'
...
export default function Home(props: HomeProps) {
    ...
    async function createPool(event: FormEvent) {
        ...
        try {
            ...
            alert('Bolão criado om sucesso, o código foi copiado para a área de transferência!')
            setPoolTitle('')
        } catch (error) {
            console.log(error)
    ...
    return (
        <div className="max-w-[1124px] h-screen mx-auto grid grid-cols-2 gap-28 items-center">
            ...
            <Image
                src={appPreviesImg}
                alt="Dois celulares exibindo uma tela da aplicação móvel do NLW Copa"
                quality={100}
            />
        </div>
    )
